...
.. "<li>" .. translate("Pre-defined domain list: Begining with 'geosite:' and the rest is a name, such as geosite:google or geosite:cn. Only works with Xray nodes reading geoip/geosite data files directly; not managed by PassWall2.") .. "</li>"
.. "<li>"
...
.. "<li>" .. translate("GeoIP: such as 'geoip:cn'. It begins with geoip: (lower case) and followed by two letter of country code. 'geoip:private' matches private/local IP ranges natively. Other codes only work with Xray nodes reading geoip data files directly; not managed by PassWall2.") .. "</li>"
.. "<li>"
	.. translate("Sing-Box rule-set: Begining with 'rule-set:remote:' or 'rule-set:local:'")
	.. "<ul>"
